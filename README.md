...
*Built for the National Agentive Hackathon by Innovista*

RoomEase (formerly FlatWalay) is an AI-powered platform designed to transform how students and professionals find compatible roommates. By leveraging multi-agent intelligence, we provide a safer and more transparent matching experience, specifically addressing the housing crisis faced by students relocating to major cities.
...
## 📄 License
This project was developed for a hackathon. See the original repository for licensing details.
